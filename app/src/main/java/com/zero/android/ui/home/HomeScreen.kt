...
fun HomeRoute(viewModel: HomeViewModel = hiltViewModel()) {
	...
	HomeScreen(
        ...
        triggerChannelSearch = { viewModel.triggerChannelSearch(true) }
	)
}
	...
	val topBar: @Composable () -> Unit = {
		AppTopBar(
            ...
            actions = {
                ...
                IconButton(onClick = { /*navController.navigate(ProfileDestination.route)*/ }, modifier = Modifier.size(32.dp)) {
                    Image(
