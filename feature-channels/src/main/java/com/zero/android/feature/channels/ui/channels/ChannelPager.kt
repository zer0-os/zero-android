...
fun ChannelsItemsList(
    ...
    val styledMessage = (channel.lastMessage?.message ?: "").messageFormatter(annotationColor = AppTheme.colors.glow)
    ...
    ConstraintLayout(
        ...
        if (isDirectChannel) {
            ...
            NameInitialsView(modifier = imageModifier.size(64.dp), userName = channel.getTitle(loggedInUserId))
        }
        Row(
